...
// Exact vector path exported from Figma "info" icon (shared with InputLabel's
// info icon — same source component, ...;9865:144086).
function InfoIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" aria-hidden="true" className="agx-toggle-with-label__info-icon">
      <path
...
export function ToggleWithLabel({
  ...
  return (
    <div className={clsx("agx-toggle-with-label", `agx-toggle-with-label--${type.toLowerCase()}`, className)}>
